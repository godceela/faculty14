...
class Patient_Database:
    ...
    def insert(self, name, address, birthday, age, contact, martial, height, weight, pulse, bodytemp, home, work, 
               fever,cough ,colds,diarrhea ,sore_throat,body_pain ,breathing ):
...
def add():
    ...
    try:
        ...
        db.insert(name_entry.get(), address_entry.get(), birthday_entry.get() , age_entry.get() ,phone_entry.get(), marital_combobox.get(),
                height_entry.get(),weight_entry.get(), pr_entry.get(),bt_entry.get(), home_entry.get(), work_entry.get(), fever = False,
                cough= False ,colds= False,diarrhea= False ,sore_throat= False,body_pain= False ,breathing = False)
